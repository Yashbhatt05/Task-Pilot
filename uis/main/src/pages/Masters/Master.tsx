  ...
  return (
    <section className='h-full w-full '>
      ...
      <div>
        <div className="flex flex-col gap-1">
          ...
          <input
            type="number"
            value={0}
            className="border border-gray-300 rounded px-3 py-[5px]"
          />
        </div>
      </div>
      <div>
      ...
      <div className="col-span-3 mt-4">
        <button onClick={handleClick} className="w-full text-left text-sm text-black font-medium bg-[#F4EEFF] px-4 py-2 rounded cursor-pointer">
          Other details
        </button>
      </div>
      {show===true && <div>
